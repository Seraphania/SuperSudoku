...
**Note:**  
Because this is for demonstration and testing purposes, it still contians a "instant solve" button. 

This is aslo left in because the chosen API does not provide puzzles with a unique solution. This means that a sudoku may be completed correctly, but will not register as correct because it doesn't match the API solution. 

A future release will include full validation of completed puzzles, for now, please make use of the 'Debug Solve' button.

_Issue creation and suggestions welcome!_
